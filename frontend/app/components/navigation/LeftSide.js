...
function LeftSide({info}){ 
return  (
<div>
	
	<div className='leftside-div-1' >
	<div className="leftside-logo">
		<div>Wrightly</div>
	</div>
		<LeftSideItem className='leftside-LeftSideItem-2' info={{icon: Home, text: "Home", to:"/"}}>
		...
		<LeftSideItem className='leftside-LeftSideItem-3' info={{icon: Home, text: "Todo", to:"/todos"}}>
		...
		<LeftSideItem className='leftside-LeftSideItem-4' info={{icon: Home, text: "Notes", to:"/notes"}}>
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#ffffff"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg>
		</LeftSideItem>
		<LeftSideItem className='leftside-LeftSideItem-5' info={{icon: Home, text: "Contact us", to:"/contactus"}}>
